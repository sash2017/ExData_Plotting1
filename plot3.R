...
#Reformatting the data appropriately
...
plot(SetTime,as.numeric(paste(my_data$Sub_metering_1)),type="n",ylab="Energy Sub Metering",xlab="")
lines(SetTime,as.numeric(paste(my_data$Sub_metering_1)),col="black")
